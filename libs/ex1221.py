...
def ex1221((x1, x2, b3, b4, b5, slacking_0, slacking_1, slacking_2)):
	restriction_0=(sqr(x1)+b3-1.25)**2
	...
	return (objective_function - 7.6672)**2+restriction_0+restriction_1+restriction_2+restriction_3+restriction_4