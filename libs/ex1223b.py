...
def ex1223b((x1, x2, x3, b4, b5, b6, b7, slacking_0, slacking_1, slacking_2, slacking_3, slacking_4, slacking_5, slacking_6, slacking_7, slacking_8)):
	restriction_0=((x1+x2+x3+b4+b5+b6+slacking_0)-5)**2
	restriction_1=((sqr(b6)+sqr(x1)+sqr(x2)+sqr(x3)+slacking_1)-5.5)**2
	...
	restriction_6=((sqr(b5)+sqr(x2)+slacking_6)-1.64)**2
	restriction_7=((sqr(b6)+sqr(x3)+slacking_7)-4.25)**2
	restriction_8=((sqr(b5)+sqr(x3)+slacking_8)-4.64)**2
	objective_function=-(-(sqr(b4-1)+sqr(b5-2)+sqr(b6-1)-log(1+b7)+sqr(x1-1)+sqr(x2-2)+sqr(x3-3))+0)
